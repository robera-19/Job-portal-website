...
const ProfileDropdown = ({
  ...
  return <div className="relative">
      ...
      <button onClick={onToggle} className="flex item-center space-x-3 p-2 rounded-xl hover:bg-gray-50 transition-colors duration-200">
        {avatar ? (
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
          ...
          <div className="border-t border-gray-100 mt-2 pt-2">
            <a href="#" onClick={onLogout} className="block px-4 py-2 text-red-600 hover:bg-red-50 transition-colors">
              Sign Out
            </a>
          </div>
        </div>
