      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            top talent, our platform offers a comprehensive suite of features
          ...
          <div>
            ...
            <div className="space-y-8">
              {jobSeekersFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-start space-x-4 p-6 rounded-xl hover:bg-blue-50 transition-all duration-300 cursor-pointer"
                >
          ...
          <div>
            ...
            <div className="space-y-8">
              {employersFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group items-start space-x-4 p-6 rounded-2xl hover:bg-purple-50 transition-all duration-300 cursor-pointer flex"
                >
