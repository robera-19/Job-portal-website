          ...
          <div className="bg-white p-6 rounded-lg">
                ...
                <div className="flex items-center gap-3 mb-6">
                  {jobDetails?.company?.companyLogo ? (
                    <img
                      ...
                      alt="Company Logo"
                      className="h-20 w-20 object-cover border-4 border-white/20 shadow-lg rounded-2xl"
                    />
                  ) : (
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                <div className="absolute top-0 right-0 w-32 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full -translate-y-16 translate-x-16"></div>
                <div className="relative z-10">
