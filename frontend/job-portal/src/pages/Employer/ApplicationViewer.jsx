                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-shrink-0">
                                {application.applicant.avatar ? (
                                  ...
                                  <div className="h-12 w-12 rounded-full object-cover bg-blue-100 flex items-center justify-center">
