            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-0 transition-all duration-200 bg-gray-50/50 placeholder-gray-500"
                />
              </div>
              ...
              <div className="sm:w-48">
                <select
                  ...
                  className="block w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200"
                >
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        ...
                        <th
                          className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[300px] sm:min-w-0"
                      ...
                      {isLoading
                        ...
                        : paginatedJobs.map((job) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap min-w-[180px] sm:min-w-0">
                                <div className="flex space-x-2">
                                  <button
                                    className="text-blue-500 hover:text-blue-800 p-8 rounded-lg hover:bg-blue-50 transition-colors duration-200"
                                    onClick={() =>
                                      navigate("/post-job", {
                                        state: { jobId: job.id },
                                      })
                  ...
                  <div>
                    <nav className="relative z-10 inline-flex rounded-md shadow-sm -space-x-px">
                      ...
                      <button
                        ...
                        disabled={currentPage === totalPages}
                        className="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-mediumtext-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Next
                      </button>
                    </nav>
